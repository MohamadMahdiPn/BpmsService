...
namespace BpmsService.Domain.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StepDefinitions_ProcessDefinitions_ProcessDefinitionId",
                        column: x => x.ProcessDefinitionId,
                        principalTable: "ProcessDefinitions",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FormsData_ProcessInstances_ProcessInstanceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StepInstances_StepDefinitions_StepDefinitionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transitions_StepDefinitions_FromStepId",
                        column: x => x.FromStepId,
                        principalTable: "StepDefinitions",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Transitions_StepDefinitions_ToStepId",
                        column: x => x.ToStepId,
                        principalTable: "StepDefinitions",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FormsData_ProcessInstanceId",
                table: "FormsData",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StepDefinitions_ProcessDefinitionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StepInstances_StepDefinitionId",
                table: "StepInstances",
